		...
		<ul class="nav nav-tabs">
			...
			<li role="presentation" class="dropdown"><a href="#" aria-controls="Other" role="dropdown" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Other <span class="caret"></span></a>
				<ul class="dropdown-menu">
					<li><a href="#tabCity" id="districts-tab" aria-controls="City" role="tab" data-toggle="tab">City/County</a></li>
					<li><a href="#tabOther" id="districts-tab" aria-controls="Suburbs" role="tab" data-toggle="tab">Suburbs</a></li>
				</ul>
			</li>
		</ul>

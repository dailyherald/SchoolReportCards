...
<div id="INDEXbody">
				...
				<div id="header">
					<p class="schoolYear">2013-2014 School Year</p>
					...
					<div id="topLists">
						<p>
							 <span><a href="../">Home</a> |</span>
							   TOP LISTS: 
							 <a href="../schools/?COUNTYlist=no&district-name=no&CITYlist=no&ISAT=yes&GROW=no&PSAE=no&ACT=no&schoolsAll=no&districtsAll=no">ISAT</a>
							 | <a href="../schools/?COUNTYlist=no&district-name=no&CITYlist=no&ISAT=no&GROW=yes&PSAE=no&ACT=no&schoolsAll=no&districtsAll=no">GROWTH</a>
							 | <a href="../schools/?COUNTYlist=no&district-name=no&CITYlist=no&ISAT=no&GROW=no&PSAE=yes&ACT=no&schoolsAll=no&districtsAll=no">PSAE</a>
							 | <a href="../schools/?COUNTYlist=no&district-name=no&CITYlist=no&ISAT=no&GROW=no&PSAE=no&ACT=yes&schoolsAll=no&districtsAll=no">ACT</a>
						</p>
					</div>
				</div>
				...
				<div id="searchBOX" class="clearFix">
					...
					<div id="searchLIST">
						<p class="searchOPTIONS">Select from one of<br /> the links below to...</p>
						<div class="searchBUTTON active" id="schoolSHOW"><strong>FIND A SCHOOL</strong></div>
						<div class="searchBUTTON" id="distSHOW"><strong>FIND SCHOOLS<br>BY DISTRICT</strong></div>
						<div class="searchBUTTON" id="citySHOW"><strong>FIND BY CITY<br>OR COUNTY</strong></div>
						<div class="searchBUTTON" id="suburbs"><strong>VIEW ALL SUBURBAN SCHOOLS</strong></div>
					</div>
		  
					<div id="schoolFIND">              
						<h6>Find a single school</h6>
						<form action='../details/' method='get'>
						<p style="margin-bottom:5px;border-bottom:1px dotted #ccc;padding-bottom:5px;">
                            <ul>
						...
						<p>
							...
							<input type="submit" id="submit" value="Get school">
						</p>
						</form>
					</div>

					<div class="hidden" id="districtFIND">              
						<h6>Find schools by district</h6>
						...
						<p style="margin-bottom:5px;border-bottom:1px dotted #ccc;padding-bottom:5px;">
                            ...
                            <li>&#8226; Type at least three of the district's four-digit state number. For District 3, you would type 003, for District 46 you would type 046 and for District 211 type 211.</li>
                             <li>&#8226; Select the district and click the "get district" button.</li></ul><br>
						</p>
						<p>
							...
							<input type="submit" id="submit" value="Get district">
						</p>
						</form>
					</div>

					<div class="hidden" id="cityFIND">              
						<h6>Find schools by city or county</h6>
...
<option value="Zion">Zion</option>
							...
							<input type="hidden" name="schoolsAll" value="no">
							<input type="hidden" name="districtsAll" value="no">
								<input type="submit" name="citySUBMIT" id="citySUBMIT"  value="Get City" >
							</p>
							</form>
						</div>
						...
						<div class="countyBox">
							...
							<p>
								...
								<input type="submit" name="countySUBMIT" id="countySUBMIT"  value="Get County" ></p>
								<input type="hidden" id="district-name" name="district-name" value="no">
								<input type="hidden" name="ISAT" value="no">
								<input type="hidden" name="PSAE" value="no">
								<input type="hidden" name="ACT" value="no">
					...
					<div class="hidden" id="findALL">              
						<h6>Find all</h6>
                        <div class="cityBox">
						<form action='../schools/' method='get'>
							<p class="searchOPTIONS">
							<label>To see a sortable list of all suburban schools in the six-county area, click below.</label>
						</p>
						<p>
                    ...
                    <div class="countyBox">
 						<form action='../schools/' method='get'>
					<p class="searchOPTIONS">
							<label>To see a sortable list of all suburban districts in the six-county area, click below.</label>
						</p>
						<p>
							<input type="hidden" name="district-name" value="no">
							<input type="hidden" name="CITYlist" value="no">
...
<div id="loaded"><img src="../images/loader1.gif" width="28" height="28" alt="Loading"></div>

    <div id="reportcardheading" class="clearFix">
		<div id="schoolinfo">
		</div>
		<div id="schoolmap">
		</div>
...
<div id="note"><p class="noteTEXT"><strong>NOTE:</strong> Elementary schools will not have PSAE or ACT results, and high schools will usually not have ISAT results.</p>
</div>

</div>

<div id="creditBox">
	<p class="pfooter">Daily Herald web app by Tim Broderick <a href="mailto:tbroderick@dailyherald.com">tbroderick@dailyherald.com</a>, with Mark Stallings<br />
	Source: Illinois State Board of Education school report card data.<br />
	Thanks to the Texas A&M University Geography department for their geocoding services.</p>
</div>
